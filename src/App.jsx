  ...
  */
  ...
  return (
    <>
      ...
      <Modal visible={modalVisible} titulo="Cargar nueva Promo" funcion={manejaModal}>
        <TablaConPaginacion columnas={columnas} datos={datos}  itemsPorPagina={5} itemsPorPaginaOpcional />
